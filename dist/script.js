...
var drop = function drop() {
  ...
  fileInputs.forEach(function (input) {
    input.addEventListener('drop', function (e) {
      ...
      var dots;
      var fileNameEl = input.previousElementSibling,
          fileNameArr = input.files[0].name.split('.');
      fileNameArr[0].length > 6 ? dots = '...' : dots = '.';
      var fileNameVal = fileNameArr[0].substring(0, 6) + dots + fileNameArr[1];
...
var filter = function filter() {
  ...
  var useFilter = function useFilter(selector) {
...
var forms = function forms() {
  ...
  uploadInputs.forEach(function (uploadInput) {
    uploadInput.addEventListener('input', function () {
      var dots;
      var fileNameEl = uploadInput.previousElementSibling,
...
var pictureSize = function pictureSize(blocksSelector) {
...
var showMoreStyles = function showMoreStyles(btnSelector, wrapperSelector) {
...
var sliders = function sliders(slidesSelector, dir, prevBtnSelector, nextBtnSelector) {
  var slideIndex = 1,
      paused = false;
